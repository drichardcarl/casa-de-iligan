...
@section('title')
	<title>Casa de Iligan - We find Homes | Home</title>
@endsection
...
<div class="banner">
	<div class="container">
		<div class="banner-info animated wow zoomIn" data-wow-delay=".5s">
			<h3 style="background-color:black;opacity:0.7">
				Find homes the easy way!
			</h3>
					...
					<article style="position: absolute; width: 100%; opacity: 0;">
						<div class="banner-wrap">
							<div class="banner-info1">
								<p style="background-color:white;opacity:0.8;color:black">
									Are you looking for Apartments ?
								</p>
							</div>
						</div>
					</article>
					<article style="position: absolute; width: fit-content; opacity: 0;">
						<div class="banner-wrap">
							<div class="banner-info1">
								<p style="background-color:white;opacity:0.8;color:black">
									Dorms or Boarding Houses ?
								</p>
							</div>
						</div>
					</article>
			...
			<div class="col-md-3 new-collections-grid">
				...
				<div class="new-collections-grid1 animated wow slideInUp" data-wow-delay=".5s">
					...
					<div class="new-collections-grid1-left simpleCart_shelfItem">
						<p>
							<i>$340</i>
							<span class="item_price">$257</span>
							<a class="item_add" href="#">add to cart </a>
						</p>
					</div>
				</div>
	...
	<div class="container">
		<div class="timer-grids">
			<div class="col-md-8 timer-grid-left animated wow slideInLeft" data-wow-delay=".5s">
				<h3>
					<a href="products.html">sunt in culpa qui officia deserunt mollit</a>
				</h3>
				<div class="rating">
					<div class="rating-left">
						<img src="images/2.png" alt=" " class="img-responsive" />
				...
				<div class="new-collections-grid1-left simpleCart_shelfItem timer-grid-left-price">
					...
					<h4>Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi
	...
	<div class="container">
		...
		<div class="newsletter animated wow slideInUp" data-wow-delay=".5s">
			...
			<form>
				...
				<input type="email" value="Enter your email address" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Enter your email address';}"
					required="">
